...
const TermsOfUse: React.FunctionComponent<AuthNavProps<"AuthTermsOfUse">> = ({
  navigation,
  route,
}) => {
    ...
    <LinearGradientProvider>
      ...
      >
        ...
        <Text style={[styles.p, {}]}>
          ...
          related to it, still belong to THOUGHTS Inc.
        </Text>

        <Text style={[styles.p, { marginTop: 10 }]}>
          THOUGHTS Inc. is committed to ensuring that the app is as useful and
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          The THOUGHTS app stores and processes personal data that you have
          ...
          security features and it could mean that the THOUGHTS app won’t work
          properly or at all. The app does use third-party services that declare
          their Terms and Conditions.
        </Text>
        <Text style={[styles.p, { marginTop: 10 }]}>
          You should be aware that there are certain things that THOUGHTS Inc.
          ...
          can be Wi-Fi or provided by your mobile network provider, but THOGHTS
          UInc. cannot take responsibility for the app not working at full
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          Along the same lines, THOUGHTS Inc. cannot always take responsibility
          ...
          on to avail the Service, THOUGHTS Inc. cannot accept responsibility.
        </Text>
        <Text style={[styles.p, { marginTop: 10 }]}>
          With respect to THOUGHTS Inc.’s responsibility for your use of the
          ...
          that we can make it available to you. THOUGHTS Inc. accepts no
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          ...
          keep using the app. THOUGHTS Inc. does not promise that it will always
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          ...
          Conditions, do not hesitate to contact us at crispengari@gmail.com.
        </Text>
      </ScrollView>
    </LinearGradientProvider>
  );
