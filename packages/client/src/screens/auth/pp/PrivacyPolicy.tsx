    ...
    <LinearGradientProvider>
      ...
      >
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          THOUGHTS Inc. built the THOUGHTS app as a Freemium app. This SERVICE
          is provided by THOUGHTS Inc. at no cost and is intended for use as is.
        </Text>
        <Text style={[styles.p, { marginTop: 10 }]}>
        ...
        <Text style={[styles.p, { marginTop: 10 }]}>
          ...
          Terms and Conditions, which are accessible at THOUGHTS unless
